...
const LinksGallery = () => {
	return (
		...
		<Row className="row-eq-height links-gallery">
			...
			<Col lg="4" md="6">
	          <GalleryItem img={rykenberg} title="Rykenberg photography" blurb="​John Rykenberg migrated to New Zealand from Holland in the mid-1950s and established a successful photography business in Albert Street, Central Auckland." link="http://www.aucklandcity.govt.nz/dbtw-wpd/virt-exhib/rykenberg/index.html" imageRef="http://www.aucklandcity.govt.nz/dbtw-wpd/exec/dbtwpub.dll?BU=http%3A%2F%2Fwww.aucklandcity.govt.nz%2Fdbtw-wpd%2FHeritageImages%2Findex.htm&AC=QBE_QUERY&TN=heritageimages&QF0=ID&NP=2&MR=5&RF=HIORecordSearch&QI0=%3D%221269-E163-24%22" imageRefText="Auckland Libraries Heritage Collections 1269-E163-24" />
	        </Col>
	    </Row>
	    </Container>
	)
